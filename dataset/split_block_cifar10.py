...
#生成数据集存储地址
basedir = "./cifar10-block-{}-task-{}".format(per_block_class_num, num_task)
...
train_dataset = torchvision.datasets.CIFAR10(root=datasetroot_dir, train=True, download=False, transform=transform)

# Download and load the CIFAR-10 test dataset
test_dataset = torchvision.datasets.CIFAR10(root=datasetroot_dir, train=False, download=False, transform=transform)
